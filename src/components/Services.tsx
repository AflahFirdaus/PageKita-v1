  ...
  const services = [
    {
      ...
      description: "Landing page profesional untuk meningkatkan konversi dan pertumbuhan bisnis Anda.",
      icon: (
    ...
    },
    {
      ...
      description: "Landing page yang menarik untuk mempromosikan produk Anda dengan efektif.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Landing page yang memukau untuk event dan kampanye marketing Anda.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Kami menawarkan berbagai jenis landing page yang dapat disesuaikan dengan kebutuhan bisnis Anda
          </p>
        </div>
